...
def create_job(
    ...
    Args:
        ...
        delivery_binding: Optional user/workspace-scoped delivery binding used
                only when ``deliver="origin"`` and the raw transport origin is
                unavailable at fire time.
    ...
    if deliver is None:
        deliver = "origin" if (origin or delivery_binding) else "local"
