    ...
    def _adjust_thread_count(self) -> None:
        ...
        if num_threads < self._max_workers:
            ...
            if hasattr(self, "_create_worker_context"):
                # Python 3.14+ moved initializer state behind WorkerContext and
                # changed _worker(executor_ref, context, work_queue).
                worker_args = (
                ...
                # Python 3.8–3.13: _worker(executor_ref, work_queue,
