...
class GatewayRunner(
    ...
    def _set_session_env(self, context: SessionContext) -> list:
        ...
        return set_session_vars(
            ...
            workspace_owner_id=str(getattr(context.source, "workspace_owner_id", "") or ""),
    ...
    async def _run_in_executor_with_context(self, func, *args):
        """Run blocking work with session context and an optional parent-owned boundary."""
        loop = asyncio.get_running_loop()
        ctx = copy_context()
        ...
        return await loop.run_in_executor(self._get_executor(), _run_bound)
