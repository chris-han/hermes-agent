    ...
    *,
    ...
    for pid, overlay in HERMES_OVERLAYS.items():
        ...
        # reflects the active region (eu.*, ap.*) not the static us.* list.
            ...
            # `hermes model` picker deliberately shows ONLY the manifest-backed
            # curated agentic list in curated order. The interactive setup flow
            # performs tier-aware Portal recommendation augmentation separately.
