...
_PROVIDER_MODELS: dict[str, list[str]] = {
    ...
    # qwen3.5-plus is kept first so it is the entitled default for the
    # generally-available DashScope key tier; qwen3.6-plus requires explicit
    # account entitlement and would otherwise yield Model.AccessDenied.
    "alibaba": [
        "qwen3.5-plus",
        "qwen3.6-plus",
        "kimi-k2.5",
