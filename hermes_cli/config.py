...
DEFAULT_CONFIG = {
    ...
    "auxiliary": {
        ...
        "title_generation": {
            ...
            "api_key": "",
            "timeout": 30,
            # Disable extended thinking/reasoning mode for title generation.
            # qwen3 family models default to thinking mode, which adds 30+ s
            # of latency to a short auxiliary request. Most providers silently
            # ignore unknown extra_body keys, so this is safe as a global default.
            # Users who explicitly need thinking on can override via config.yaml:
            #   auxiliary.title_generation.extra_body.enable_thinking: true
