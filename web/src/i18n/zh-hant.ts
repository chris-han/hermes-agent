...
export const zhHant: Translations = {
  ...
  organization: {
    ...
    subtitle:
      "Control which organization this user belongs to, whether shared operational knowledge is enabled, and who can access org-scoped defaults.",
    statusLabel: "Status",
    statuses: {
    ...
    current: "current",
    noneAssigned: "personal-only",
    personalOnlyMode: "Personal-only mode",
    roleLabel: "Role",
    sharingTitle: "Shared knowledge authorization",
    sharingDescription:
      "Enable or disable access to organization-scoped T5 knowledge for this user.",
    sharingEnabled: "Organization sharing enabled",
    sharingDisabled: "Organization sharing disabled",
    createOrganization: "Create organization",
    joinOrganization: "Join organization",
    namePlaceholder: "Organization display name",
    idPlaceholder: "organization-id",
    joinHint:
      "Joining an existing organization defaults to pending approval unless self-join is enabled.",
    nameRequired: "Organization name is required",
    idRequired: "Organization ID is required",
    joinRequested: "Join request submitted",
    created: "Organization created",
    membershipsTitle: "Memberships",
    noMemberships: "This user is not attached to any organization yet.",
    switchAction: "Switch",
    switched: "Active organization changed",
    membersTitle: "Members",
    activeMembers: "Active members ({count})",
    pendingMembers: "Pending requests ({count})",
    memberApproved: "Member approved",
    memberRemoved: "Member removed",
    auditAndInvites: "Audit and Invites",
    inviteTitle: "Invite member",
    invitePlaceholder: "email, user id, or handle",
    inviteAction: "Create invite",
    inviteCreated: "Invite recorded",
    inviteeRequired: "Invitee is required",
    auditTitle: "Recent audit trail",
    noAuditEvents: "No organization audit events yet.",
    actorLabel: "Actor",
