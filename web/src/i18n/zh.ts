...
export const zh: Translations = {
  ...
  organization: {
    ...
    title: "组织访问",
    subtitle:
      "管理当前用户归属的组织、是否启用组织共享知识，以及谁可以访问组织范围的默认设置。",
    statusLabel: "状态",
    statuses: {
      unassigned: "未分配",
      pending: "待审批",
    ...
    current: "当前",
    noneAssigned: "仅个人模式",
    personalOnlyMode: "仅个人模式",
    roleLabel: "角色",
    sharingTitle: "共享知识授权",
    sharingDescription: "为该用户启用或关闭组织范围的 T5 共享知识访问。",
    sharingEnabled: "已启用组织共享",
    sharingDisabled: "已关闭组织共享",
    createOrganization: "创建组织",
    joinOrganization: "加入组织",
    namePlaceholder: "组织显示名称",
    idPlaceholder: "organization-id",
    joinHint: "加入现有组织默认进入待审批状态，除非该组织允许自助加入。",
    nameRequired: "组织名称不能为空",
    idRequired: "组织 ID 不能为空",
    joinRequested: "加入申请已提交",
    created: "组织已创建",
    membershipsTitle: "成员关系",
    noMemberships: "该用户还未关联任何组织。",
    switchAction: "切换",
    switched: "已切换当前组织",
    membersTitle: "组织成员",
    activeMembers: "活跃成员（{count}）",
    pendingMembers: "待审批请求（{count}）",
    memberApproved: "成员已批准",
    memberRemoved: "成员已移除",
    auditAndInvites: "审计与邀请",
    inviteTitle: "邀请成员",
    invitePlaceholder: "邮箱、用户 ID 或账号",
    inviteAction: "创建邀请",
    inviteCreated: "邀请已记录",
    inviteeRequired: "邀请对象不能为空",
    auditTitle: "最近审计记录",
    noAuditEvents: "暂无组织审计记录。",
    actorLabel: "操作人",
    subjectLabel: "对象",
  },
