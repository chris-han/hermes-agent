...
def _session_db_file_path() -> Path:
    """Return the state DB path used by default SessionDB construction."""
...
class EventBridge:
    ...
    def _poll_once(self, db):
        ...
        db_file = Path(getattr(db, "db_path", None) or _session_db_file_path())
        try:
