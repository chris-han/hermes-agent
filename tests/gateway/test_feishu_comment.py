    ...
    def test_run_comment_agent_uses_workspace_canonical_session(self):
        ...
        class FakeAgent:
            ...
            def run_conversation(self, prompt, conversation_history=None):
                ...
                captured["sandbox_key"] = current_sandbox_key()
                captured["sandbox_env"] = os.environ.get("SEMANTIER_SANDBOX_KEY")
        ...
        assert captured["sandbox_key"] == "ws:ws-123:session:ws-123:session_abc"
        assert captured["sandbox_env"] == "ws:ws-123:session:ws-123:session_abc"

    def test_resolve_workspace_context_for_open_id_returns_workspace(self):
        from plugins.platforms.feishu.feishu_comment import _resolve_workspace_context_for_open_id
