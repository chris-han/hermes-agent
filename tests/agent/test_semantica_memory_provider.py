...
def test_semantica_provider_is_discovered_by_hermes_loader():
...
def test_semantica_provider_persists_workspace_state_after_restart(tmp_path: Path):
    ...
    assert state["provider_class"] == "SemanticaMemoryProvider"
    ...
    assert provider_b.prefetch("Procedure", session_id="session-b").startswith("## Semantica Memory")
