...
class TestGatewayBridgeCodeParity:
    ...
    def test_gateway_has_auxiliary_bridge(self):
        ...
        assert 'AUXILIARY_{_upper}_PROVIDER' in content
        assert 'AUXILIARY_{_upper}_MODEL' in content
        assert 'AUXILIARY_{_upper}_BASE_URL' in content
        assert 'AUXILIARY_{_upper}_API_KEY' in content
