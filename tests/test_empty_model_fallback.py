...
class TestGetDefaultModelForProvider:
    ...
    def test_alibaba_default_uses_current_catalog_first_model(self):
        from hermes_cli.models import get_default_model_for_provider
        assert get_default_model_for_provider("alibaba") == "qwen3.7-max"
        assert get_default_model_for_provider("alibaba-coding-plan") == "qwen3.7-max"
