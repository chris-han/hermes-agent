...
def test_resolve_codex_runtime_credentials_refreshes_expiring_token(tmp_path, monkeypatch):
    ...
    resolved = auth_mod.resolve_codex_runtime_credentials()
...
def test_resolve_codex_runtime_credentials_force_refresh(tmp_path, monkeypatch):
    ...
    resolved = auth_mod.resolve_codex_runtime_credentials(force_refresh=True, refresh_if_expiring=False)
...
def test_login_openai_codex_force_new_login_skips_existing_reuse_prompt(monkeypatch):
    ...
    monkeypatch.setattr(auth_mod, "_save_codex_tokens", _fake_save)
    monkeypatch.setattr(auth_mod, "_update_config_for_provider", lambda *args, **kwargs: "/tmp/config.yaml")
    monkeypatch.setattr(
        "builtins.input",
    ...
    auth_mod._login_openai_codex(
        SimpleNamespace(),
        auth_mod.PROVIDER_REGISTRY["openai-codex"],
