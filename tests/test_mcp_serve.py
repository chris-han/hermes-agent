...
class TestEventBridgePollE2E:
    ...
    def test_session_db_file_path_prefers_semantier_runtime_state_dir(self, tmp_path, monkeypatch):
        import mcp_serve
        ...
        assert mcp_serve._session_db_file_path() == runtime_home / "state.db"
