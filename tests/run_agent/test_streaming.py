...
class TestCodexStreamCallbacks:
    ...
    def test_codex_text_delta_fires_callback(self):
        ...
        mock_client = MagicMock()
        mock_client.responses.create.return_value = iter([mock_event_text, mock_event_done])
    ...
    def test_codex_stream_refreshes_activity_on_every_event(self):
        ...
        mock_client = MagicMock()
        mock_client.responses.create.return_value = iter([mock_event_text_1, mock_event_text_2, mock_event_done])
