...
class TestSaveSessionLogAtomicWrite:
    ...
    def test_workspace_logs_are_metadata_only(self, agent, tmp_path):
        ...
        assert payload["message_storage"] == "sqlite"
...
def test_save_trajectory_writes_to_session_scoped_file(tmp_path):
    ...
    save_trajectory(
        ...
        metadata={
            "source_gateway": "web",
            "session_id": "ws-123:demo",
            "chat_name": "should-be-dropped",
    ...
    assert '"timestamp": "2026-05-11T12:00:00+00:00"' in lines[0]
    assert "chat_name" not in lines[0]
...
def test_saved_session_trajectory_row_preserves_hermes_contract(tmp_path):
    ...
    assert entry["timestamp"] == "2026-05-11T12:00:00+00:00"
