...
def _reset_module_state():
    ...
    # --- hermes_constants — context-local HERMES_HOME override ---
    # Tests that scope runtime home in-process must not redirect config/env
    # reads for later tests on the same xdist worker.
    try:
        from hermes_constants import set_hermes_home_override
        set_hermes_home_override(None)
    except Exception:
