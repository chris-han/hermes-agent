...
def _render_table_block_for_telegram(table_block: list[str]) -> str:
    ...
    for index, row in enumerate(table_block[2:], start=1):
        ...
        # Build the bulleted lines for this row.  Keep the heading column as a
        # bullet too so the rewritten block preserves every table cell.
        bullets: list[str] = []
