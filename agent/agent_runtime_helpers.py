...
def invoke_tool(agent, function_name: str, function_args: dict, effective_task_id: str,
    ...
    if function_name == "todo":
        ...
        def _execute(next_args: dict) -> Any:
            ...
            from tools.memory_tool import memory_write_requires_explicit_request as _memory_write_requires_explicit_request
            gate_error = _memory_write_requires_explicit_request(messages)
