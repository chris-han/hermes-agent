...
SUMMARY_PREFIX = (
    ...
    "IMPORTANT: Your persistent memory (MEMORY.md, USER.md) remains available as candidate background context — "
    "do not discard it merely because earlier turns were compacted, but do not treat memory alone as authority for "
    "consequential claims, commitments, or external actions. "
