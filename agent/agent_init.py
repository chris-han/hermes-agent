...
def init_agent(
    ...
    # Default local session logs live under the active HERMES_HOME/sessions.
    # Gateway workspace sessions may later rebind these paths to a
    # workspace-owned Hermes home.
